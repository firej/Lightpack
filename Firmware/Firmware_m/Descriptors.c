...
const USB_Descriptor_Device_t PROGMEM DeviceDescriptor =
{
	...
	.SerialNumStrIndex      = 4,  //setting NO_DESCRIPTOR here will result in "?" serial, and multiple lightpack withsame "?" won't work
	//provide "" serial
	...
	.Config =
		{
			...
			.TotalInterfaces        = LIGHTPACKS_COUNT,
	...
	.HID_ReportINEndpoint =
		{
			...
			.EndpointAddress        = GENERIC_IN_EPADDR1,
		...
		.HID_ReportINEndpoint1 =
			{
				...
				.EndpointAddress        = GENERIC_IN_EPADDR2,
				.Attributes             = (EP_TYPE_INTERRUPT | ENDPOINT_ATTR_NO_SYNC | ENDPOINT_USAGE_DATA),
				.EndpointSize           = GENERIC_EPSIZE,
				.PollingIntervalMS      = 0x05
			},
			...
			.HID_ReportINEndpoint2 =
				{
					...
					.EndpointAddress        = GENERIC_IN_EPADDR3,
					.Attributes             = (EP_TYPE_INTERRUPT | ENDPOINT_ATTR_NO_SYNC | ENDPOINT_USAGE_DATA),
					.EndpointSize           = GENERIC_EPSIZE,
					.PollingIntervalMS      = 0x05
				},
...
{
   .Header                 = {.Size = USB_STRING_LEN(0), .Type = DTYPE_String},
                                    ...
                                    const void** const DescriptorAddress)
{
	...
	switch (DescriptorType)
	{
		...
		case HID_DTYPE_HID:
			...
			{
				Address = &ConfigurationDescriptor.HID_GenericHID1;
				Size    = sizeof(USB_HID_Descriptor_HID_t);
			}
#endif
#if (LIGHTPACKS_COUNT >= 3)
			...
			{
				Address = &ConfigurationDescriptor.HID_GenericHID2;
				Size    = sizeof(USB_HID_Descriptor_HID_t);
			}
#endif
			break;
